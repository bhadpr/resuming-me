...
export function AppShell() {
  ...
  // TODO(P1-04): track('skip_today', { reason }) when skip UI lands
  // TODO(P1-04): track('activity_paused', { duration }) when pause UI lands
  // TODO(P1-04): track('rest_day', { duration }) when rest-day UI lands
